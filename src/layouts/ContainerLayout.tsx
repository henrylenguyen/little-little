...
const ContainerLayout: React.FC<Props> = (props) => {
  return (
    <>
      <div className='relative  flex h-[100vh] items-center justify-center xl:hidden'>
      ...
      <div className='hidden xl:block'>
        ...
        <div className='container mx-auto '>
          <div className=' container-layout relative  mt-[-2%] min-h-[800px] rounded-b-[40px] pl-32 pr-10 pt-[5%]'>
            <Outlet></Outlet>
          </div>
        </div>
      </div>
